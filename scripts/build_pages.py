...
<body>
  <main class=\"shell\">
    ...
    <section class=\"hero\"><div><h1>Kathiyawadi,<br><em>priced clearly.</em></h1><p class=\"dek\">A concise view of the Ahmedabad vegetarian dining market, built for operators, investors and teams deciding what to launch next.</p></div><div class=\"stamp\"><strong>Read the market</strong>Use the midpoint to frame your offer, the area mix to choose where to compete, and the leaders to understand the bar.</div></section>
